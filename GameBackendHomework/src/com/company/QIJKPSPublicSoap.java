...
public class QIJKPSPublicSoap
{
    ...
    public QIJKPSPublicSoap(){}

    public QIJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QIJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QIJExtendedSoapSerializationEnvelope envelope= new QIJExtendedSoapSerializationEnvelope(QIJExtendedSoapSerializationEnvelope.VER11);
